...
select * from tbArtistas where codArt order by codArt;
select * from tbGravadoras where codGrav order by codGrav;
select * from tbCategorias where codCat order by codCat;
select * from tbEstados;
select * from tbCidades where codCid order by codCid;
select * from tbClientes where codCli order by codCli;
select * from tbConjuge where codConj order by codConj;
select * from tbFuncionarios where codFunc order by codFunc;
select * from tbDependentes where codDep order by codDep;
select * from tbTitulos where codTit order by codTit;
select * from tbPedidos where numPed order by numPed;
select * from tbTitulos_Artistas where codTit order by codTit;
select * from tbTitulos_Pedidos where numPed order by numPed;